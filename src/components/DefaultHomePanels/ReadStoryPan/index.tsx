...
import { Sparkles, MoveRight, CircleArrowDown } from "lucide-react";
import Link from "next/link";
import { JSX } from "react";

type ReadStoryPanProps = {
    randomStoryId: string | null;
    setReadOpen: () => void; // <-- updated: no parameter
};

const ReadStoryPan = ({
    randomStoryId,
    setReadOpen,
}: ReadStoryPanProps): JSX.Element => {
    return (
