import { CircleArrowUp, MoveRight, Sparkles } from 'lucide-react';
import Link from 'next/link';
import { JSX } from 'react'
import { Button } from '../ui/button';
import Image from 'next/image';

type ReadStoryExpandedPanelProps = {
    randomStoryId: string | null;
    setReadOpen: (value: boolean) => void;
}

const ReadStoryExpandedPanel = ({
    randomStoryId,
    setReadOpen,
}: ReadStoryExpandedPanelProps): JSX.Element => {
...
export default ReadStoryExpandedPanel;